...
public class ManaStream extends FightAction {

	public ManaStream(String selfAnime, String opponentAnime) {
	...
	public String getMessage(Player player1, Player player2) {
		...
		return player1.getNickname() + " feeled a slight flow of magic and regain some MP.";
	}
